import { PointerLockControls, OrbitControls, Html, useVideoTexture } from "@react-three/drei"
...
export default function Experience({ localStream, remoteStream }: ExperienceProps) {
